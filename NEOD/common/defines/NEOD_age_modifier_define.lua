...
-- must type in 16 down below and NOT 15! This portrait pack supports up to 520 portraits (uses 20 new custom property slots for a total of 33),
...
NDefines.NCharacter.PORTRAIT_ADULT_MALE_AGE_THRESHOLD = 0		-- Male child to adult age portrait switch
NDefines.NCharacter.PORTRAIT_ADULT_FEMALE_AGE_THRESHOLD = 0	    -- Female child to adult age portrait switch